...
export function validateSeoDate(value: string, label = "Date"): string {
...
function sitemapUrl(page: SitemapPageInput, siteUrl: string | URL): string | undefined {
...
export function generateSitemap(pages: readonly SitemapPageInput[], options: SitemapOptions): string {
...
export function generateSitemapIndex(entries: readonly SitemapIndexEntry[]): string {
