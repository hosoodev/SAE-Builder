...
function decodedPathSegments(pathname: string, label: string): readonly string[] {
  let decoded: string;
  try {
...
export function normalizeSeoRoute(route: string): string {
...
export function normalizeSiteBase(siteUrl: string | URL): URL {
...
export function resolveCanonical(input: CanonicalInput): string {
...
export function canonicalBelongsToSite(canonical: string | URL, siteUrl: string | URL): boolean {
...
export function isExternalCanonical(canonical: string | URL, siteUrl: string | URL): boolean {
...
function resolveMediaUrl(siteUrl: string | URL, route: string, value: string): string {
  const trimmed = value.trim();
...
export function renderMetadataTags(metadata: ResolvedMetadata): string {
  const lines = [
