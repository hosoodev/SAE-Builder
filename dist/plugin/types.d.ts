...
export interface BuilderPlugin {
    ...
    contentLoaded?(entry: NormalizedContentEntry, context: PluginContext): MaybePromise<NormalizedContentEntry | void>;
    transformContent?(entry: NormalizedContentEntry, context: PluginContext): MaybePromise<NormalizedContentEntry | void>;
